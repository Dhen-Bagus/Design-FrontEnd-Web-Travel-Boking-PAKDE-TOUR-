...
import bandungHero from "../assets/images/bandung.png";
  ...
  return (
    <div className="destinasi-detail-page">
      ...
      <div className="destinasi-hero">
        <img src={bandungHero} alt="Bandung" className="destinasi-hero-image" />
        <div className="destinasi-hero-overlay">
          <h1 className="destinasi-hero-title">Bandung</h1>
          <p className="destinasi-hero-subtitle">Kota Kembang yang Sejuk dan Romantis</p>
        </div>
      </div>
      ...
      <div className="destinasi-content-wrapper">
        ...
        <div className="rating-section">
          <div className="rating-box">
            ...
            <span className="rating-text">(8.234 review)</span>
          </div>
        ...
        <div className="deskripsi-section">
          <h2>Tentang Bandung</h2>
          <p>
            Bandung terkenal dengan udaranya yang sejuk, kulinernya yang lezat, 
            dan berbagai tempat wisata instagramable. Dari Lembang hingga Ciwidey, 
            Bandung menyimpan pesona alam yang memukau. Kota ini juga dikenal sebagai 
            surga belanja dengan banyak factory outlet dan distro kreatif.
          </p>
        </div>
          ...
          <div className="wisata-grid">
            <div className="wisata-card">
              <div className="wisata-card-content">
                ...
                <p>Gunung berapi dengan kawah yang masih aktif</p>
              </div>
            </div>
            <div className="wisata-card">
              <div className="wisata-card-content">
                <h3>Kawah Putih Ciwidey</h3>
                <p>Danau kawah dengan air berwarna putih kehijauan</p>
              </div>
            </div>
            <div className="wisata-card">
              <div className="wisata-card-content">
                <h3>Farmhouse Lembang</h3>
                <p>Spot foto ala Eropa dengan pemandangan indah</p>
              </div>
            </div>
            <div className="wisata-card">
              <div className="wisata-card-content">
                <h3>Gedung Sate</h3>
                <p>Ikon kota Bandung dengan arsitektur unik</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="hotel-section">
          ...
          <div className="hotel-grid">
            ...
            <div className="hotel-card">
              ...
              <p>⭐ 4.9 • Mulai Rp 1.500.000/malam</p>
            </div>
            <div className="hotel-card">
              <h3>De Paviljoen</h3>
              <p>⭐ 4.5 • Mulai Rp 800.000/malam</p>
            </div>
          </div>
        </div>
        ...
        <div className="kuliner-section">
          <h2>🍴 Kuliner Khas Bandung</h2>
          <div className="kuliner-grid">
            <div className="kuliner-card">
              <h3>Batagor</h3>
              <p>Bakso tahu goreng khas Bandung</p>
            </div>
            <div className="kuliner-card">
              <h3>Seblak</h3>
              <p>Kerupuk basah dengan rasa pedas</p>
            </div>
            <div className="kuliner-card">
              <h3>Surabi</h3>
              <p>Kue tradisional dengan berbagai topping</p>
            </div>
          </div>
        </div>
        ...
        <button className="book-ticket-btn" onClick={handleBookTicket}>
          <FaPlane /> Pesan Tiket Pesawat ke Bandung
        </button>
      </div>
